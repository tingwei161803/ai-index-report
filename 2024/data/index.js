  ...
  /* ------------------------------------------------------------ CHAPTERS */
  {
    ...
    qa: [
      ...
      { q: { en: "4 · Economy", zh: "4 · 經濟" },
        a: { en: "Global corporate AI investment — the broadest measure, including mergers and acquisitions — fell about 20% to $189.2 billion, and private investment fell for a second year to $96.0 billion. Yet generative AI funding nearly octupled to $25.2 billion. US investment reached $67.2 billion, about 8.7× China's. AI job postings in the US fell from 2.0% to 1.6% of all listings. 55% of organizations now use AI, up from 50%. China installed 52.4% of the world's industrial robots. AI was mentioned on 394 Fortune 500 earnings calls.",
             zh: "全球企業 AI 投資 — 含併購在內的最廣義口徑 — 下滑約 20% 至 1,892 億美元，私人投資則連續第二年下滑至 960 億美元。但生成式 AI 募資近乎成長八倍至 252 億美元。美國投資達 672 億美元，約為中國的 8.7 倍。美國 AI 職缺占比由 2.0% 降至 1.6%。55% 的組織已使用 AI，前一年為 50%。中國安裝了全球 52.4% 的工業機器人。財星 500 大企業中有 394 場法說會提及 AI。" },
