...
window.SITE_SECTIONS = [
  ...
  /* --------------------------------------------------- SCALING TIMELINE */
  {
    ...
    events: [
      { date:  { en: "2012 · AlexNet", zh: "2012 · AlexNet" },
      ...
      { date:  { en: "2017 · Transformer", zh: "2017 · Transformer" },
      ...
      { date:  { en: "2019 · RoBERTa Large", zh: "2019 · RoBERTa Large" },
      ...
      { date:  { en: "2020 · GPT-3 175B", zh: "2020 · GPT-3 175B" },
      ...
      { date:  { en: "2023 · GPT-4", zh: "2023 · GPT-4" },
      ...
      { date:  { en: "2024 · Llama 3.1 405B", zh: "2024 · Llama 3.1 405B" },
