...
window.SITE_SECTIONS = [
  ...
  /* ------------------------------------------------ SELF-DRIVING CARS CHART */
  {
    ...
    title:    { en: "% of US drivers afraid of self-driving vehicles",
                zh: "% 害怕自駕車的美國駕駛" },
    subtitle: { en: "AAA's annual survey, most recently conducted in January 2025 and designed to represent about 97% of US households. Fear spiked in 2023 and has eased since, but it remains above its 2021 level — and only 13% say they trust the technology.",
                zh: "AAA 的年度調查,最新一次於 2025 年 1 月進行,設計上代表約 97% 的美國家戶。恐懼在 2023 年飆高後已經回落,但仍高於 2021 年的水準 — 而且只有 13% 的人說自己信任這項技術。" },
    series: [
